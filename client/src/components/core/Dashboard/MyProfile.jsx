        ...
        <div className="max-w-full px-6 py-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-1">Monitor and manage yard activities in real-time</p>
            </div>
                ...
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="pl-10 pr-4 py-3 w-full lg:w-80 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                    />
                  </div>
                </div>
                  ...
                  {filteredActivities.length === 0 ? (
                    ...
                    filteredActivities.map((activity, index) => (
                      <div
                        ...
                        className="bg-gradient-to-r from-gray-50 to-gray-50/50 rounded-xl p-6 hover:shadow-md transition-all duration-200 border border-gray-100 hover:border-gray-200"
                      >
                        <div className="flex items-center justify-between">
