...
def get_stock_forecasting(request,*args,**kwargs):
    if request.method=='POST':
        try:
            ...
            data=pd.read_csv('/home/hp/Codes/Project/Transpectra/models/RouteOptimization/RouteOptimization/RouteOptimization/ULIP/ulip_store_final_dataset.csv')
            ...
            with open(r'/home/hp/Codes/Project/Transpectra/models/RouteOptimization/RouteOptimization/RouteOptimization/ULIP/encoder.pkl','rb') as file:
            ...
            with CustomObjectScope({
                ...
                model=load_model(r'/home/hp/Codes/Project/Transpectra/models/RouteOptimization/RouteOptimization/RouteOptimization/ULIP/ulip_model_stock_forecasting.h5')
